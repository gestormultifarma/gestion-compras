# analysis/transformer/transformer_quincenales.py

from analysis.transformer.transformer_base import BaseTransformer
import pandas as pd

class TransformadorQuincenales(BaseTransformer):
    columnas_estandarizadas = {
        "Codigo": "codigo",
        "Min-Quincenales": "min_quincenales",
        "Max-Quincenales": "max_quincenales"
    }
