# analysis/etl/etl_runner_fact_rotacion_updated.py

import os
import warnings
from datetime import datetime

# Usar el extractor actualizado
from analysis.extractor.extractor_fact_rotacion_updated import ExtractorFactRotacion
...
class FactRotacionETLRunner:
    ...
    def run(self):
        ...
        try:
            self.logger.info("🚀 Iniciando ETL para fact_rotacion (versión actualizada)")
...
if __name__ == '__main__':
    # Para ejecutar desde línea de comandos: python -m analysis.etl.etl_runner_fact_rotacion_updated
